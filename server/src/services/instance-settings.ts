...
export function normalizeExperimentalSettings(raw: unknown): InstanceExperimentalSettings {
  ...
  if (parsed.success) {
    return {
      ...
      enableClassicTaskInterface: parsed.data.enableClassicTaskInterface ?? true,
      ...
      enableStaleActiveRunEvaluations: parsed.data.enableStaleActiveRunEvaluations ?? true,
