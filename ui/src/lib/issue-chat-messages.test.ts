    ...
    const messages = buildIssueChatMessages({
      comments: [
        createComment({
          ...
          presentation: { kind: "discussion_qa", tone: "info", detailsDefaultOpen: false, threadId: "thread-1", role: "question" },
        }),
        createComment({
          ...
          presentation: { kind: "discussion_qa", tone: "info", detailsDefaultOpen: false, threadId: "thread-1", role: "answer" },
        }),
