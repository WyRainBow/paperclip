...
/**
 * Qoder CLI stream-json follows the Claude Code event schema, so transcript
 * mapping mirrors the claude-local parser (minus ACP event handling).
 */
export function parseQoderStdoutLine(line: string, ts: string): TranscriptEntry[] {
